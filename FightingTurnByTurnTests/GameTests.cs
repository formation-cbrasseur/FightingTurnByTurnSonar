...
namespace FightingTurnByTurnTests
{
    ...
    public class GameTests
    {
        ...
        {
            Assert.AreEqual(0, game.CountPlayers());
        }
        ...
        public void AddingOnePlayers_WillGiveOnePlayersCount()
        {
            ...
            Assert.AreEqual(1, game.CountPlayers()); 
        }
        ...
        public void AddingTwoPlayers_WillGiveTwoPlayersCount()
        {
            ...
            Assert.AreEqual(2, game.CountPlayers());
        }
...
Divad");
            ...
            Assert.AreEqual("David", game.Players[0].Name);
            Assert.AreEqual("Divad", game.Players[1].Name);
        }
